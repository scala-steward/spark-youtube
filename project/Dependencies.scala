...
object Dependencies {
  ...
  val coreDependencies = Seq(
    ...
    ("com.google.apis" % "google-api-services-youtube" % "v3-rev20220711-1.32.1")
      .excludeAll(
        ExclusionRule("commons-logging")
      ),
    ...
    "com.sksamuel.elastic4s" % "elastic4s-core_2.12" % "8.2.1",
    ("com.sksamuel.elastic4s" % "elastic4s-client-esjava_2.12" % "8.2.1")
      .excludeAll(
        ExclusionRule("commons-logging")
      ),
    "com.softwaremill.retry" %% "retry" % "0.3.5"
